...
class StatusScreen: UIView, UISearchBarDelegate {
    ...
    lazy var pencil: UIImageView = {
        let imagem = UIImageView()
        imagem.translatesAutoresizingMaskIntoConstraints = false
        imagem.image = UIImage(systemName: "pencil")
        imagem.tintColor = .systemBlue
        return imagem
    }()
    ...
    func setUpConstraints(){
        NSLayoutConstraint.activate([
            ...
            pencil.topAnchor.constraint(equalTo: self.statsLabel.topAnchor, constant: 10),
            pencil.leadingAnchor.constraint(equalTo: self.camera.trailingAnchor, constant: 30),
